...
let urlCallBack = process.argv[6]
const setFacebook = (pClienteID, pClientSecret,pUrlCallBack) => {
  ...
  pUrlCallBack ? urlCallBack = pUrlCallBack :urlCallBack = process.env.URL_CALL_BACK
}
setFacebook(clientID, clientSecret,urlCallBack)
...
if ((modoFork == undefined || modoFork == 'FORK') ? false : cluster.isMaster) {
  ...
  //const PORT = parseInt(process.argv[5]) || 8080;
